 ...
 */
final class Version20260502115305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collab_requests CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE requester_id requester_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collab_requests CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE description description TEXT NOT NULL, CHANGE location location VARCHAR(100) NOT NULL, CHANGE requester_id requester_id BIGINT DEFAULT 1 NOT NULL');
