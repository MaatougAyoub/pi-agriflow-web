...
final class Version20260410222129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservations ADD commission NUMERIC(10, 2) NOT NULL, ADD message LONGTEXT DEFAULT NULL, DROP caution, DROP message_demande, DROP reponse_proprietaire, DROP date_demande, DROP date_reponse, DROP contrat_url, DROP contrat_signe, DROP date_signature_contrat, DROP paiement_effectue, DROP date_paiement, DROP mode_paiement, CHANGE quantite quantite INT NOT NULL, CHANGE statut statut VARCHAR(20) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL');
