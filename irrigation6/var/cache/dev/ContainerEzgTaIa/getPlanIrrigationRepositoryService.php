 ...
 */
class getPlanIrrigationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanIrrigationRepository' shared autowired service.
     *
     * @return \App\Repository\PlanIrrigationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanIrrigationRepository.php';

        return $container->privates['App\\Repository\\PlanIrrigationRepository'] = new \App\Repository\PlanIrrigationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
