 ...
 */
class getCultureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CultureRepository' shared autowired service.
     *
     * @return \App\Repository\CultureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CultureRepository.php';

        return $container->privates['App\\Repository\\CultureRepository'] = new \App\Repository\CultureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
