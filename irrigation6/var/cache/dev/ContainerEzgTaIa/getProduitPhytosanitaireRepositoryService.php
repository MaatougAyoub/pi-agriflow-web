 ...
 */
class getProduitPhytosanitaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitPhytosanitaireRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitPhytosanitaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitPhytosanitaireRepository.php';

        return $container->privates['App\\Repository\\ProduitPhytosanitaireRepository'] = new \App\Repository\ProduitPhytosanitaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
