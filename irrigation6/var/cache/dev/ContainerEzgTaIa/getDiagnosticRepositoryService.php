 ...
 */
class getDiagnosticRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DiagnosticRepository' shared autowired service.
     *
     * @return \App\Repository\DiagnosticRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DiagnosticRepository.php';

        return $container->privates['App\\Repository\\DiagnosticRepository'] = new \App\Repository\DiagnosticRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
