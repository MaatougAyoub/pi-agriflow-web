 ...
 */
class getPlanIrrigationJourRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanIrrigationJourRepository' shared autowired service.
     *
     * @return \App\Repository\PlanIrrigationJourRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanIrrigationJourRepository.php';

        return $container->privates['App\\Repository\\PlanIrrigationJourRepository'] = new \App\Repository\PlanIrrigationJourRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
