...
class CollabRequest
{
    ...
    private ?int $needed_people = null;

    public function getNeeded_people(): ?int
    {
        return $this->needed_people;
    }

    public function setNeeded_people(int $needed_people): self
    {
        $this->needed_people = $needed_people;
        return $this;
    }
    ...
    #[ORM\Column(type: 'integer', nullable: false)]
    private ?int $requester_id = null;

    public function getRequester_id(): ?int
    {
        return $this->requester_id;
    }

    public function setRequester_id(int $requester_id): self
    {
    ...
    public function setNeededPeople(int $needed_people): static
    {
        $this->needed_people = $needed_people;
    ...
    public function setRequesterId(int $requester_id): static
    {
        $this->requester_id = $requester_id;
